...
/**
   ...
   */ public new
 SBMLConverter clone() {
    global::System.IntPtr cPtr = libsbmlPINVOKE.SBMLReactionConverter_clone(swigCPtr);
    SBMLReactionConverter ret = (cPtr == global::System.IntPtr.Zero) ? null : new SBMLReactionConverter(cPtr, true);
    return ret;
  }
