...
/**
   ...
   */ public new
 SBMLConverter clone() {
    global::System.IntPtr cPtr = libsbmlPINVOKE.SBMLRuleConverter_clone(swigCPtr);
    SBMLRuleConverter ret = (cPtr == global::System.IntPtr.Zero) ? null : new SBMLRuleConverter(cPtr, true);
    return ret;
  }
