...
/**
   ...
   */ public new
 SBMLConverter clone() {
    global::System.IntPtr cPtr = libsbmlPINVOKE.SBMLIdConverter_clone(swigCPtr);
    SBMLIdConverter ret = (cPtr == global::System.IntPtr.Zero) ? null : new SBMLIdConverter(cPtr, true);
    return ret;
  }
