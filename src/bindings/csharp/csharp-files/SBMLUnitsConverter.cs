...
/**
   ...
   */ public new
 SBMLConverter clone() {
    global::System.IntPtr cPtr = libsbmlPINVOKE.SBMLUnitsConverter_clone(swigCPtr);
    SBMLUnitsConverter ret = (cPtr == global::System.IntPtr.Zero) ? null : new SBMLUnitsConverter(cPtr, true);
    return ret;
  }
